...
public class OfficeController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<ICollection<OfficeCollectionResponse>>> Get()
    {
    ...
    [HttpGet("{officeId}")]
    public async Task<ActionResult<OfficeResponse>> GetOffice([FromRoute] string officeId)
    {
    ...
    //[Authorize(Roles = "Receptionist")]
    [HttpPost]
    public async Task<ActionResult> Create([FromForm] OfficeRequest request)
    {
    ...
    //[Authorize(Roles = "Receptionist")]
    [HttpPatch("{officeId}")]
    public async Task<ActionResult> Update([FromRoute] string officeId)
    {
        await _officeService.ChangeOfficeStatusAsync(officeId);
    ...
    public async Task<ActionResult> Edit([FromRoute] string officeId, [FromForm] OfficeRequest request)
    {
